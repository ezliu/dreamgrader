...
LOREM_WORDS = ['a', 'augue', 'cum', 'cum', 'cursus', 'diam,', 'dolor,', 'duis', 'enim', 'enim', 'eros', 'eros', 'est', 'feugiat', 'id', 'in', 'justo', 'molestie', 'nam', 'orci', 'potenti', 'ridiculus', 'risus', 'rutrum', 'sed', 'suspendisse', 'tempor,', 'tempor,', 'tempus', 'urna']
HTML_TOKENS = [',',
 '.',
 '/body',
 '/div',
